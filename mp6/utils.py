...
def hyperparameters():
    ...
    parser.add_argument('--epsilon', type=float, default=0.1, help='exploration parameter')    #default=0.05
    parser.add_argument('--gamma', type=float, default=0.9, help='discount reward factor. represents how confident a '
                                                                  'model should be able to predict future rewards') #default=0.99
    parser.add_argument('--lr', type=float, default=0.1, help='learning rate') #default=1e-4
